...
namespace ServiceApotheke.API.Migrations
{
    ...
    [Migration("20260721211613_RemoveStripeAndRenameEscrowStatus")]
    partial class RemoveStripeAndRenameEscrowStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ServiceApotheke.API.Models.Timesheet", b =>
                {
                    b.HasOne("ServiceApotheke.API.Models.JobApplication", "JobApplication")
                        .WithOne("Timesheet")
                        .HasForeignKey("ServiceApotheke.API.Models.Timesheet", "JobApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
